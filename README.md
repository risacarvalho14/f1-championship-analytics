...
* *A deliberate data-model limitation:* the dashboard's Year/Constructor slicers do not cross-filter every visual, because doing so would have required a many-to-many relationship between views — a relationship type Power BI itself warns against due to the risk of inflated/duplicated totals. Data accuracy was prioritised over full cross-page interactivity.
